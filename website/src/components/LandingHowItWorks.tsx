      ...
      <div className="mt-20 flex flex-col gap-20">
        ...
        <div className="landing-reveal grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-[var(--landing-muted)] text-[0.9375rem] leading-[1.7] max-w-[28rem]">
              Point Agent Orchestrator at your repo with a YAML config. Choose your agent, set up
              trackers and notifiers. One file, full control.
            </p>
          </div>
          <div className="landing-card rounded-2xl p-8 min-h-[260px]">
            <div className="bg-black/40 rounded-xl overflow-hidden font-mono text-[0.8125rem]">
              ...
              <div className="px-5 py-4 leading-[1.8]">
                ...
                <div className="text-[var(--landing-muted)] opacity-60">
        ...
        <div className="landing-reveal grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div className="md:order-2">
            ...
            <p className="text-[var(--landing-muted)] text-[0.9375rem] leading-[1.7] max-w-[28rem]">
              Each agent spawns in an isolated worktree. They write code, create PRs, run tests, and
              fix failures. Monitor everything from the live dashboard, or let them run.
            </p>
          </div>
          <div className="landing-card rounded-2xl p-8 min-h-[260px] md:order-1">
            <div className="rounded-2xl overflow-hidden bg-black/30">
              <div className="flex items-center gap-2 px-4 py-2.5 bg-[var(--landing-card-bg)] border-b border-[var(--landing-border-subtle)]">
                ...
                <div className="w-2.5 h-2.5 rounded-full bg-[rgba(255,240,220,0.12)]" />
                <div className="w-2.5 h-2.5 rounded-full bg-[rgba(255,240,220,0.12)]" />
                <span className="text-[0.6875rem] text-[var(--landing-muted)] opacity-50 ml-2">
              ...
              <div className="grid grid-cols-4 gap-2 p-3">
                ...
                <DashColumn
                  title="Pending"
                  cards={[{ title: "Add rate limiting", meta: "#44 · PR #312", agent: "aider" }]}
                />
                <DashColumn
                  title="Review"
                  cards={[
        ...
        <div className="landing-reveal grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-[var(--landing-muted)] text-[0.9375rem] leading-[1.7] max-w-[28rem]">
              Agents create pull requests, address review comments, fix CI failures, and get them to
              mergeable state. Your morning starts with merged PRs, not a backlog.
            </p>
          </div>
    ...
    <div>
      ...
      {cards.map((card) => (
        ...
        >
          ...
          <div className="font-mono text-[0.5625rem] text-[var(--landing-muted)] opacity-50">
            {card.meta}
          </div>
          <div className="flex items-center gap-1 mt-1 font-mono text-[0.5625rem] text-[var(--landing-muted)] opacity-60">
            {card.done ? (
              ...
              <span
                ...
                style={{
                  background: card.amber ? "rgba(251,191,36,0.7)" : "rgba(134,239,172,0.7)",
                }}
              />
            )}
            {card.agent}
