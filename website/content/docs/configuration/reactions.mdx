...
<Callout type="warning">
  `auto-merge` is currently an intent flag, not a bypass. AO does not ignore branch protection,
  reviews, or failing checks.
</Callout>
...
<Cards>
  <Card
    ...
    description="Apply reaction overrides to one project."
  />
  <Card
