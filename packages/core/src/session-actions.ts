...
// kill was moved to session-actions-shared.ts to break the session-spawn ↔
// session-actions circular import. Re-export here for backward compatibility.
export { kill } from "./session-actions-shared.js";
