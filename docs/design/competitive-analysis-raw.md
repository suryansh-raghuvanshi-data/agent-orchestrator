...
_Compiled February 2026 via text/HTML analysis of 14 competitor sites_
_Used as source material for design-brief.md_
...
_Ground-truth values confirmed via Playwright CSS extraction — see design-brief.md._
